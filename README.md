...
Download the latest version from the [Releases Page](https://github.com/TariqMK/HexDex/releases), extract the `.zip` and run Hexdex. All required folders will be automatically created. Enjoy!
